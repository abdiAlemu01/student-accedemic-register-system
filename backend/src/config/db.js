...
// Auto-detect: Use DATABASE_URL in production (Render), local config in development
const pool = process.env.DATABASE_URL 
  ? new Pool({
      connectionString: process.env.DATABASE_URL,
      ssl: {
        rejectUnauthorized: false // Required for Supabase and most cloud PostgreSQL
      },
      max: 20,
...
console.log(`📊 Database Mode: ${process.env.DATABASE_URL ? 'Remote (DATABASE_URL)' : 'Local (Individual Config)'}`);
